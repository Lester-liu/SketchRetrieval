...
void WritePixels(){
  unsigned char *pixels(4 * GLUTwindow_width * GLUTwindow_height);
  glReadPixels(0,0,GLUTwindow_width,GLUTwindow_height,GL_RGB,GL_UNSIGNED_BYTE,*pixels);
  ofstream output("picture");
  output.write((char*)pixels,4 * GLUTwindow_width * GLUTwindow_height* sizeof(unsigned char));
  output.close();
}
